...
public class StudentManagement {
        ...
        do {
            ...
            switch (choice){
                ...
                case 2:
                    ...
                    break;
                case 3:
                    StudentManagement.calStudentRating();
                    break;
                case 4:
                    StudentManagement.calStatusStudent();
                    break;
                case 5:
                ...
                case 7:
                    ...
                    break;
                case 8:
                    StudentManagement.staticByRate();
                    break;
                case 9:
                    StudentManagement.staticByStatus();
                    break;
                case 10:
                    System.exit(0);
                    break;
    ...
    public static void calStudentRating (){
        for (int i = 0; i < numberStudent; i++) {
    ...
    public static void calStatusStudent (){
        for (int i = 0; i < numberStudent; i++) {
    ...
    public static void staticByRate(){
    ...
    public static void staticByStatus(){
        int numberPass = 0;
        int numberFail = 0;
        for (int i = 0; i < numberStudent; i++) {
            Student student = arrStudent[i];
        ...
        System.out.println("PASS : " + numberPass);
